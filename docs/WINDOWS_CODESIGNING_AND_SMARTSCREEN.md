...
```powershell
Get-AuthenticodeSignature "C:\SafeNex\SafeNex_Vision_Edge_Setup_0.1.0_Windows_x64.exe" | Format-List Status, StatusMessage, SignerCertificate
```
...
& signtool sign /fd SHA256 /sha1 $cert.Thumbprint /tr $timestamp /td SHA256 ".\SafeNex_Vision_Edge_Setup_0.1.0_Windows_x64.exe"

& signtool verify /pa /v ".\SafeNex_Vision_Edge_Setup_0.1.0_Windows_x64.exe"
```
