...
const AUDIT: PageAudit[] = [
  ...
  { page: "WorkPlans.tsx",             title: "작업계획서 목록",   results: { access: "pass",    soft: "pass",    ime: "na",      audit: "pass",    zod: "na",   toast: "pass",    term: "na" } },
  ...
  { page: "TbmLogs.tsx",               title: "TBM 일지",          results: { access: "pass",    soft: "fail",    ime: "fail",    audit: "fail",    zod: "fail", toast: "fail",    term: "fail" } },
  { page: "SafetyInspections.tsx",     title: "안전점검",          results: { access: "pass",    soft: "pass",    ime: "pass",    audit: "fail",    zod: "fail", toast: "fail",    term: "fail" } },
  { page: "SiteReadinessChecklist.tsx",title: "현장 적용 체크",    results: { access: "pass",    soft: "partial", ime: "na",      audit: "na",      zod: "na",   toast: "pass",    term: "na" } },
  ...
  { page: "Approvals.tsx",             title: "결재함",            results: { access: "pass",    soft: "na",      ime: "na",      audit: "pass",    zod: "na",   toast: "fail",    term: "na" } },
  ...
  { page: "MobileWorkers.tsx",         title: "[M] 근로자 QR",     results: { access: "pass",    soft: "na",      ime: "na",      audit: "pass",    zod: "na",   toast: "pass",    term: "na" } },
  { page: "MobileRiskAssessment.tsx",  title: "[M] 위험성평가",    results: { access: "pass",    soft: "pass",    ime: "na",      audit: "na",      zod: "na",   toast: "pass",    term: "na" } },
  { page: "MobileWorkPlans.tsx",       title: "[M] 작업계획",      results: { access: "pass",    soft: "pass",    ime: "na",      audit: "na",      zod: "na",   toast: "pass",    term: "na" } },
