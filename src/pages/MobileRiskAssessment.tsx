...
export default function MobileRiskAssessment() {
  ...
  // assessment_runs has no company_id — do NOT use applyCompanyFilter (breaks query).
  // RLS + target_company_ids scoping handles contractor visibility.
  ...
  const load = async () => {
    ...
    // Extra client guard for worker/viewer: only runs targeted to their company (or open targets)
