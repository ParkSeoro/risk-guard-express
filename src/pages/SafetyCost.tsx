    ...
    <Dialog open={itemEditOpen} onOpenChange={setItemEditOpen}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <div className="space-y-1"><Label>공급가액</Label><Input type="number" value={editingItem.supply_amount} onChange={(e) => setEditingItem((p) => ({ ...p, supply_amount: e.target.value }))} /></div><div className="space-y-1"><Label>부가세</Label><Input type="number" value={editingItem.vat_amount} onChange={(e) => setEditingItem((p) => ({ ...p, vat_amount: e.target.value }))} /></div><div className="space-y-1"><Label>금액</Label><Input type="number" value={editingItem.amount} onChange={(e) => setEditingItem((p) => ({ ...p, amount: e.target.value }))} /></div>
