-- ============================================================
-- Approval follow-ups:
-- 1) Assessment / work_plan status vocabulary SSOT (Korean)
-- 2) Remove silent EXCEPTION WHEN OTHERS on assessment status
-- 3) gc_manager signature slot key
-- 4) Client cannot UPDATE approvals (RPC-only mutations)
-- ============================================================
...
DROP POLICY IF EXISTS "Writers can update approvals" ON public.approvals;
